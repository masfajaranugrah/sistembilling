  ...
  $(document).on('click', '.btn-detail, td.control', function(e) {
      ...
      const html = `
        ...
        <p><strong>Tanggal Jatuh Tempo:</strong> ${rowData[13]}</p>
         <p><strong>Catatan:</strong> ${rowData[16]}</p>
        <p><strong>Actions:</strong> ${rowData[17]}</p>
    `;
                    ...
                    if(response.success) {
                       ...
                       Swal.fire({
                            ...
                            html: `
                                ...
                                <a href="${response.pdfUrl}" target="_blank" class="btn btn-primary">Cetak Kwitansi</a>
                            `,
                            icon: 'success',
                            showConfirmButton: false,
                            allowOutsideClick: true, // biar bisa klik close
                            didClose: () => {
                                // reload halaman saat modal ditutup
                                location.reload();
                            }
                        });
   ...
   <td>
    @php
        ...
        $badgeClass = match($status) {
            ...
            'proses_verifikasi' => 'badge bg-warning text-dark', // Kuning background, teks hitam
