...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_user_table = document.querySelector('.datatables-pelanggan'),
  ...
  if (dt_user_table) {
    const dt_user = new DataTable(dt_user_table, {
      ajax: {
    url: 'http://127.0.0.1:8000/dashboard/admin/pelanggan/data',
    dataSrc: ''
  ...
  { data: 'no_ktp', title: 'No. KTP' },
  { data: 'no_whatsapp', title: 'No. WhatsApp' },
  { data: 'no_telp', title: 'No. Telepon' },
  { 
    data: 'paket', 
    title: 'Nama Paket', 
    render: function(data) { 
      return data ? data.nama_paket : '-'; 
    }
  },
  { data: 'tanggal_mulai', title: 'Mulai' },
  { data: 'tanggal_berakhir', title: 'Berakhir' },
],
